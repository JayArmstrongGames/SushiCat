...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("Company Name"),HX_CSTRING("SushiCat"),HX_CSTRING("com.sample.project"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(32)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("SushiCat"),null(),null());
	}
return null();
}
